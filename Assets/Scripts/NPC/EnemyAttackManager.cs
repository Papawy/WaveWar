			...
			case TYPE.NORMAL:
				{
					...
					//attackNote.transform.rotation.
					attackNote.transform.forward = gameObject.transform.forward;
					...
					attackNote2.transform.forward = gameObject.transform.forward;
					...
					attackNote3.transform.forward = gameObject.transform.forward;
